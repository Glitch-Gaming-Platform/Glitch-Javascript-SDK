(function () {
  ...
  const asap =
    typeof queueMicrotask !== 'undefined'
      ...
      : (typeof process !== 'undefined' && nextTick) || _setImmediate;
  ...
  ***************************************************************************** */
  ...
  const siteId = (script === null || script === void 0 ? void 0 : script.dataset.glitchHostingSite) || '';
  const releaseId = (script === null || script === void 0 ? void 0 : script.dataset.glitchHostingRelease) || '';
  const apiBase = (script === null || script === void 0 ? void 0 : script.dataset.glitchApiBase) || 'https://api.glitch.fun/api';
  Config.setConfig(apiBase, '');
  const ready = Hosting.startPlaySession({
      ...
      var _a;
      const session = ((_a = response === null || response === void 0 ? void 0 : response.data) === null || _a === void 0 ? void 0 : _a.data) || (response === null || response === void 0 ? void 0 : response.data) || response;
      if (window.GlitchHosting)
          window.GlitchHosting.session = session;
  ...
  window.GlitchHosting = {
      ready,
      getContext: () => { var _a; return ((_a = window.GlitchHosting) === null || _a === void 0 ? void 0 : _a.session) || null; },
  };

})();
//# sourceMappingURL=hosting-runtime.js.map
